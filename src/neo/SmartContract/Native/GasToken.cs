...
{
    /// <summary>
    /// Represents the DVG token in the NXA/DVITA system.
    /// </summary>
    public sealed class GasToken : FungibleToken<AccountState>
    {
        public override string Symbol => "DVG";
        ...
        internal override async ContractTask OnPersist(ApplicationEngine engine)
        {
            ...
            ECPoint[] validators = DVITA.GetNextBlockValidators(engine.Snapshot, engine.ProtocolSettings.ValidatorsCount);
