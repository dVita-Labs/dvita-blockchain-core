...
namespace Neo.SmartContract.Native
{
    ...
    public abstract class NativeContract
    {
        ...
        /// <summary>
        /// Gets the instance of the <see cref="DvitaToken"/> class.
        /// </summary>
        public static DvitaToken DVITA { get; } = new();
        ...
        {
            UInt160 committeeMultiSigAddr = DVITA.GetCommitteeAddress(engine.Snapshot);
