...
namespace Neo.UnitTests.SmartContract.Native
{
    ...
    public class UT_RoleManagement
    {
        ...
        public void TestSetAndGet()
        {
            ...
            UInt160 committeeMultiSigAddr = NativeContract.DVITA.GetCommitteeAddress(snapshot1);
            ECPoint[] validators = NativeContract.DVITA.ComputeNextBlockValidators(snapshot1, ProtocolSettings.Default);
